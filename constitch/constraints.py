...
class Constraint:
    ...
    Fields:
        ...
        dx (int): X coordinate offset from image1 to image2
            ...
            offset is measured from pos1 of the box of the first image
            to pos1 of the box of the second image
        dy (int): Y coordinate offset from image1 to image2
            Measured the same way as dx, from the 0,0 pixel in image1
            to the 0,0 pixel in image2, or from box1.pos1 to box2.pos1
...
class ConstraintFilter:
    ...
    or a custom function that returns a bool, eg ConstraintFilter(lambda const: const.box1.pos1[0] < 5000)
